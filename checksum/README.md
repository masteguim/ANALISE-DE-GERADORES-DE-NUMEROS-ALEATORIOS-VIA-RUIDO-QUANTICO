...
Os checksums são utilizados apenas para verificação de integridade dos arquivos e não constituem mecanismo de autenticação, assinatura digital ou certificação criptográfica dos resultados experimentais.
